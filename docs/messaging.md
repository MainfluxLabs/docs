...
The `config` structure consists of the following fields: `content_type` and `transformer`.
...
To publish a message, a thing with a proper profile should send the following request:
